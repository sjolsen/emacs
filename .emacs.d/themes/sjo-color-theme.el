...
(custom-theme-set-faces
 ...
 '(Info-title-1-face ((t (:inherit Info-title-2-face :height 1.728))))
 '(Info-title-2-face ((t (:inherit Info-title-3-face :height 1.44))))
 '(Info-title-3-face ((t (:inherit Info-title-4-face :height 1.2))))
 '(Info-title-4-face ((t (:inherit (variable-pitch bold)))))
